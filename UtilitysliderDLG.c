...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "slider", ID_FRAMEWIN_0, 0, 0, 854, 480, 0, 0x64, 0 },
  { SLIDER_CreateIndirect, "Slider", ID_SLIDER_0, 173, 170, 262, 47, 0, 0x0, 0 },
